...
При внесении изменений в проект придерживайтесь современного C# 12 стиля (.NET 10.0):
...
- .NET SDK 10.0.401, закреплен в `global.json`; источник пакетов задан в `NuGet.Config`.
...
- Фреймворк: `net10.0-windows10.0.26100.0`
